...
rsync -av --delete "$CONF_DIR/klassy" "$DOTS_DIR/config/"
...
rsync -av --delete "$CONF_DIR/panel-colorizer" "$DOTS_DIR/config/"
...
rsync -av --delete "$CONF_DIR/dolphinrc.txt" "$DOTS_DIR/config/"
